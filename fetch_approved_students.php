...
// Prepare the SQL statement to fetch approved students
$sql = "SELECT id, student_univ_id, student_fname, student_mname, student_lname, student_nextension, student_paddress, student_course, student_college, student_type, student_gender, identification_pic FROM student_reg WHERE student_status = 'approved'"; // Added identification_pic
